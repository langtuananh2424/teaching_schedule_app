...
// Lớp này giúp truyền dữ liệu giữa các màn hình an toàn hơn so với Map.
class Schedule {
  final String time;
  ...
  Schedule({required this.time, required this.subject, required this.room, required this.status});
}
...
class Student {
  ...
  Student({required this.name, required this.studentId, this.attendanceStatus = AttendanceStatus.present});
}
...
// --- DỮ LIỆU MÔ PHỎNG (SỬ DỤNG LỚP Schedule) ---
...
// --- 3. MÀN HÌNH DANH SÁCH LỊCH DẠY (SCHEDULE SCREEN) ---
...
// --- 4. WIDGET MỤC LỊCH DẠY (SCHEDULE ITEM) ---
...
// --- 5. MÀN HÌNH CHI TIẾT LỊCH DẠY (DETAIL SCREEN) ---
...
// --- 6. MÀN HÌNH ĐĂNG KÝ NGHỈ (ABSENCE REGISTRATION SCREEN) ---
...
// --- 7. MÀN HÌNH ĐĂNG KÝ DẠY BÙ (SUBSTITUTE REGISTRATION SCREEN) ---
