    ...
    try {
      ...
      if (userRole == 'ROLE_MANAGER') {
        try {
          ...
          // Lấy department của Manager - ĐÚNG: dùng /api/lecturers/{id}
          ...
          final departmentLecturerIds = <int>{};
          ...
          print('📊 Department has ${departmentLecturerIds.length} lecturers');

          // Lọc requests theo department
          filteredRequests = allRequests
              .where((r) => departmentLecturerIds.contains(r.lecturerId))
              .toList();

          print(
            '✅ Filtered to ${filteredRequests.length} requests for department',
          );
        } catch (e) {
          print('⚠️ Could not filter by department: $e');
          // Nếu lỗi, giữ nguyên tất cả requests
        }
      }
